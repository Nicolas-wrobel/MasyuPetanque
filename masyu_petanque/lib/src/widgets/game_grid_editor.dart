  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTapDown: (TapDownDetails details) {
          ...
          if (widget.tool == ToolMode.addBlackCircle) {
            widget.gameMap.grid.blackPoints.add(Point(x: (x1), y: (x2)));
          } else if (widget.tool == ToolMode.addWhiteCircle) {
            widget.gameMap.grid.whitePoints.add(Point(x: (x1), y: (x2)));
          } else if (widget.tool == ToolMode.addBlackLine) {
          ...
          } else if (widget.tool == ToolMode.eraseItem) {
          } else if (widget.tool == ToolMode.undoAction) {}
